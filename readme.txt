...
== Changelog ==
=v1.3.0=
*قابلیت ساخت دوره از صفحه محصول بازسازی شد و کاملاً بهینه شد و امکان درج جلسات با تعداد بالا امکان پذیر شد
*فونت های گوگل به فونت داخلی تغییر پیدا کرد تا در قطی کندی ایجاد نشود
*بخش نمایش دوره مدرن به پلاگین اضافه شد
*تنظیمات پلاگین کاملتر شد
*سازگاری کامل با اسپات پلیر انجام شد(نیازی به پلاگین اسپات پلیر نیست)
*جهت درج خودکار جلسات از اسپات بدون کندی اکستنشن اختصاصی ایجاد شد
*بخش مدرسین اضافه شد
*بخش آزمون ساز اضافه شد
*بخش متاساز اختصاصی اضافه شد
*قابلیت قفل کردن بخش های خاصی از دوره اضافه شد
